...
import { Download, Settings, Soup, Terminal, BookOpen, Briefcase, Coins, Folder, Brain, LucideIcon } from 'lucide-react';
    ...
    <aside className="w-64 shrink-0 bg-sidebar dark:bg-[#09090b]/40 border-r border-zinc-200/50 dark:border-zinc-900/45 flex flex-col h-full sticky top-0 px-4 py-6 select-none backdrop-blur-md">
      ...
      <div className="mt-auto space-y-3">
        ...
        <div className="pt-3 border-t border-zinc-200/50 dark:border-zinc-900/50">
          <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-zinc-200/20 dark:hover:bg-zinc-900/30 border border-transparent hover:border-zinc-200/30 dark:hover:border-zinc-900/20 cursor-pointer group/footer">
            <div className="relative flex items-center justify-center w-8.5 h-8.5 rounded-full border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm text-xs font-semibold text-zinc-700 dark:text-zinc-300">
              JD
